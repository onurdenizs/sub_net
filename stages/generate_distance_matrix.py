    ...
    try:
            ...
            for j, row_j in df.iterrows():
                if row_i["station"] == row_j["station"]:
                    ...
                    dist = euclidean_distance(
                        row_i["center_coordinates"], row_j["center_coordinates"]
                    )
        ...
        for i, row_i in df.iterrows():
            ...
            for j, row_j in df.iterrows():
                ...
                connected = row_j["station"] in connections_i.get(
                    "West", set()
        ...
        close_unconnected = long_df[
            (long_df["distance_m"] < threshold) & (~long_df["connected"])
        ]
        ...
        logger.info(
            f"⚠️ Saved close-but-unconnected stations to: {close_unconnected_path}"
        )
