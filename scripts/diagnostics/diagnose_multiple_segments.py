...
forward_filtered = polygon_df[
    (polygon_df["START_OP"] == sta1) & (polygon_df["END_OP"] == sta2)
]

# 2️⃣ sta2 → sta1 yönündeki satırlar
backward_filtered = polygon_df[
    (polygon_df["START_OP"] == sta2) & (polygon_df["END_OP"] == sta1)
]
...
# 1️⃣ sta1 → sta2 yönündeki satırlar
forward_original = original_polygon_df[
    (original_polygon_df["START_OP"] == sta1) & (original_polygon_df["END_OP"] == sta2)
]

# 2️⃣ sta2 → sta1 yönündeki satırlar
backward_original = original_polygon_df[
    (original_polygon_df["START_OP"] == sta2) & (original_polygon_df["END_OP"] == sta1)
]
